...
// Summary Text
print("From an early age, we are told to obey — not to ask 'why'.",
3, 1, 1, summary_para1_fade, 75, 575, .125, .125, 1.25);
print("Memorizing facts is praised, while understanding is overlooked",
1, 1, 1, summary_para1_fade, 75, 550, .125, .125, 1.25);

print("Later in life, the narrative hardly changes.",
1, 1, 1, summary_para2_fade, 75, 475, .125, .125, 1.25);
print("Doctor or Engineer — we are told these are the only worthy path. ",
1, 1, 1, summary_para2_fade, 75, 450, .125, .125, 1.25);

print("Becoming a doctor is often a privilege of the wealthy.",
1, 1, 1, summary_para3_fade, 75, 375, .125, .125, 1.25);
print("Becoming an engineer is reduced to a life of silent obedience. ",
1, 1, 1, summary_para3_fade, 75, 350, .125, .125, 1.25);

print("But engineering was meant to be a tool for change — not compliance.",
1, 1, 1, summary_para4_fade, 75, 275, .125, .125, 1.25);
print("To build, question, and reshape the world around us.",
1, 1, 1, summary_para4_fade, 75, 250, .125, .125, 1.25);
print("Not to follow orders like soldiers in someone else's war.",
...
print("INTERNATIONAL ISLAMIC UNIVERSITY ",
1, 1, 1, 1,
530, 715,
.1, .1,
1);

print("Chittagong,Bangladesh",
1, 1, 1, 1,
590, 695,
.08, .08,
1);
